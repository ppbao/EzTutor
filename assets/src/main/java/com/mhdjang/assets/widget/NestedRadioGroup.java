...
public class NestedRadioGroup extends LinearLayout {
    ...
    private OnHierarchyChangeListener onHierarchyChangeListenerInternal = new OnHierarchyChangeListener() {
        ...
        public final void onChildViewAdded(View parent, View child) {
            ...
            if (NestedRadioGroup.this.onHierarchyChangeListener != null) {
                NestedRadioGroup.this.onHierarchyChangeListener.onChildViewAdded(
                        parent, child);
            }
        }
        ...
        public final void onChildViewRemoved(View parent, View child) {
            ...
            if (NestedRadioGroup.this.onHierarchyChangeListener != null) {
                NestedRadioGroup.this.onHierarchyChangeListener.onChildViewRemoved(
                        parent, child);
            }
        }
    };
    ...
    public NestedRadioGroup(Context context, AttributeSet attrs, int defStyle) {
     ...
     * parameter.
     *
     * @param index the index of the view to select in this group.
     */
    ...
    public interface OnCheckedChangeListener {
         ...
         *
         * @param checkedView newly checked view or null if selection was cleared in the
         *                    group.
         */
