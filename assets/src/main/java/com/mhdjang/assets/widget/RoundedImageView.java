...
public class RoundedImageView extends ImageView {
    ...
    private List<Boolean> mCornerDirection;
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCornerDirection = new ArrayList<Boolean>();
        mCornerDirection.add(a.getBoolean(R.styleable.RoundedImageView_corner_top_left, false));
        mCornerDirection.add(a.getBoolean(R.styleable.RoundedImageView_corner_top_right, false));
        mCornerDirection.add(a.getBoolean(R.styleable.RoundedImageView_corner_bottom_left, false));
        mCornerDirection.add(a.getBoolean(R.styleable.RoundedImageView_corner_bottom_right, false));
    ...
    private void updateAttrs(Drawable drawable) {
        ...
        if (drawable instanceof RoundedDrawable) {
            ((RoundedDrawable) drawable).setScaleType(mScaleType)
                    ...
                    .setCornerDirection(mCornerDirection)
                    .setBorderWidth(mBorderWidth).setBorderColors(mBorderColor)
                    .setOval(mOval);
    ...
    public List<Boolean> getCornerDirection() {
        return mCornerDirection;
    }

    public void setCornerDirection(List<Boolean> direction) {
        mCornerDirection = direction;
        updateDrawableAttrs();
        updateBackgroundDrawableAttrs(false);
    }
